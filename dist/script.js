...
const {
  default: $
} = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    this.click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(modal).fadeIn(200);
      document.body.style.overflow = 'hidden';
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(modal).click(e => {
        if (e.target.classList.contains('modal')) {
          Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(modal).fadeOut(200);
        }
      });
    }, i);
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(`${modal} [data-close]`).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(modal).fadeOut(200);
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    const buttons = []; //    setting = [[text, [classNames], close, cb]]
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.slider = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    const _toSlide = j => {
      ...
      index = j;
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).find('[data-slide-to]').addClass('active').eq(j).siblings().removeClass('active');
    };
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).find('[data-slide-to]').click(e => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).addClass('tab__item_active').siblings().removeClass('tab__item_active');
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).closest('.tab').find('.tab__content').removeClass('tab__content_active').eq(i).addClass('tab__content_active');
    });
  }
};
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggle="modal"]').click(e => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])(e.target).createModal({
    title: 'Modal Title',
    body: 'zdec kakoito text. Mozhete pridumat sami. Esli est jelanie konechno.'
  }, {
    count: 2,
    setting: [['Save Change', ['btn_seccess', 'mr_10'], false, () => {
      alert(`change saved`);
    }], ['Close', ['btn_danger', 'mr_10'], true]]
  });
});
